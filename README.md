...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/itemadapter-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10193&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/itemadapter-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `itemadapter` can be installed with:

```
conda install itemadapter
```

It is possible to list all of the versions of `itemadapter` available on your platform with:
